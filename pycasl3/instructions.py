...
from .argtypes import adrx, noarg, r, r1r2, radrx, strlen
from .utils import a2l, get_bit, l2a
...
def sll(machine, r, adr, x):
    ...
    machine.GR[r] = ans
    if 0 < v:
        return flags(machine.GR[r], logical=True, OF=get_bit(prev_p, 15 - (v - 1)))
    else:
